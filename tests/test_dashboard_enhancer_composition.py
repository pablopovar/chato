...
from nerdo_api.review_changes_ui import enhance_dashboard_page as enhance_changes_page
...
def test_dashboard_enhancers_compose_in_runtime_order() -> None:
    ...
    page = enhance_changes_page(page)
    ...
    assert "Send back for changes" in page
    assert "Activate reviewed domain" in page
